...
/*
	...
	10/27/2010 - changed the $.mask() to $.maskInput() - Aaron S.
*/
(function($) {
	var pasteEventName = ($.browser.msie ? 'paste' : 'input') + ".maskInput";
	...
	$.fn.extend({
		...
		unmaskInput: function() { return this.trigger("unmaskInput"); },
		maskInput: function(maskInput, settings) {
			...
			var tests = [];
			var partialPosition = maskInput.length;
			var firstNonMaskPos = null;
			var len = maskInput.length;
			...
			return this.each(function() {
				var input = $(this);
				var buffer = $.map(maskInput.split(""), function(c, i) { if (c != '?') return defs[c] ? settings.placeholder : c });
